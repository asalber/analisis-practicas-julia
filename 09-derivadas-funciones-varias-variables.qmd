...
a.  Calcular el polinomio de Taylor de segundo grado de $f$ en el punto $(1,1)$ y representarlo gráficamente.
    ...
    p2(s,t) = f(a, b) + dot(∇f(a, b), [s-a, t-b]) + dot(∇²f(a,b) * [s-a; t-b],  [s-a, t-b])
...
La velocidad de una reacción química típicamente depende de la temperatura y de la concentración de los reactivos. En una reacción de hidrólisis del acetato de etilo por hidróxido de sodio (NaOH) en una solución acuosa, la velocidad de reacción viene dada por la fórmula $R(t,e,s)=\frac{t}{3}\sqrt[3]{e^2s^2}$, donde $t$ es la temperatura de la reacción, $e$ la concentración de acetato de etilo y $s$ la concentración de hidróxido de sodio.
