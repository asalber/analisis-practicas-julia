...
n1 = 1:2:10
n2 = 2:2:10
Plots.scatter(n1, x.(n1), label=L"$x_{2n-1}$")
Plots.scatter!(n2, x.(n2), label=L"$x_{2n}$")
```
...
p3 = Plots.scatter([x(n) for n=1:50], legend=false)
