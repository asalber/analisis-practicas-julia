...
Un coche circula por una circuito elíptico cuya trayectoria viene dada por la función vectorial $f(t)=(400\cos(t), 100\operatorname{sen}(t))$, donde $t$ está dado en minutos y las coordenadas de $f$ en metros.
